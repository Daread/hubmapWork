...
outCounts="W136.heart.apex.s1-peak_counts.txt"
tmpRegions="W136.heart.apex.s1-temp_regions.gz"
   ...
   bedtools slop -i W136.heart.apex.s1-merged_peaks.bed -g W136.heart.apex.s1-human.chromosome_sizes.sorted.txt -b 0     | bedtools merge -i stdin     | gzip > ${tmpRegions}
