...
outCalledCellsCounts="W144.heart.apex.s1-called_cells.txt"
outCellWhiteList="W144.heart.apex.s1-called_cells_whitelist.txt"
outCallCellsStats="W144.heart.apex.s1-called_cells_stats.json"

   python /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/call_cells.py ${outCalledCellsCounts}                                        ${outCellWhiteList}                                        --fit_metadata ${outCallCellsStats}                                        --count_report W144.heart.apex.s1-count_report.txt 
