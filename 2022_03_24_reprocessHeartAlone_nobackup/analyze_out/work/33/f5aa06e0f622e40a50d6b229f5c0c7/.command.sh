...
outCounts="W139.heart.septum.s1-peak_counts.txt"
tmpRegions="W139.heart.septum.s1-temp_regions.gz"
   ...
   bedtools slop -i W139.heart.septum.s1-merged_peaks.bed -g W139.heart.septum.s1-human.chromosome_sizes.sorted.txt -b 0     | bedtools merge -i stdin     | gzip > ${tmpRegions}
