...
cat start.log > trim.log
    printf "** Start process 'trim_fastqs' for Liver.fq.part1-L002.fastq.gz at: $(date)
...
" >> piece.log
    ...
    printf "    Process command:
        trim_galore Liver.fq.part1-L002.fastq.gz -a AAAAAAAA --three_prime_clip_R1 1
            --gzip -o ./trim_out/
...
" >> piece.log
    ...
    mkdir trim_out
    trim_galore Liver.fq.part1-L002.fastq.gz         -a AAAAAAAA         --three_prime_clip_R1 1         --gzip         -o ./trim_out/
...
" >> piece.log
    cp piece.log Liver.fq.part1-L002_trim.txt
