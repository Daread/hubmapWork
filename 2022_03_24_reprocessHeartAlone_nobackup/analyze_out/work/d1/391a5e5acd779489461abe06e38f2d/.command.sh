...
PROCESS_BLOCK='makeReducedDimensionMatrixProcess'
   ...
   inPeakMatrix="W139.heart.RV.s1-peak_matrix.mtx.gz"
   inSampleName="W139.heart.RV.s1"

	outScrubletHistFile="W139.heart.RV.s1-scrublet_hist.png"
   outScrubletTableFile="W139.heart.RV.s1-scrublet_table.csv"
outLsiCoordsFile="W139.heart.RV.s1-lsi_coords.txt"
outUmapCoordsFile="W139.heart.RV.s1-umap_coords.txt"
outUmapPlotFile="W139.heart.RV.s1-umap_plot"
outMonocle3CdsFile="W139.heart.RV.s1-monocle3_cds.rds"
   outBlackListRegionsFile="W139.heart.RV.s1-blacklist_regions_file.log"
   outReduceDimensionsLogFile="W139.heart.RV.s1-reduce_dimensions.log"
   umi_cutoff=100
   frip_cutoff=0.1
   frit_cutoff=0.05
