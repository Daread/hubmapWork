...
outCounts="W134.heart.apex.s1-peak_counts.txt"
tmpRegions="W134.heart.apex.s1-temp_regions.gz"
   ...
   bedtools slop -i W134.heart.apex.s1-merged_peaks.bed -g W134.heart.apex.s1-human.chromosome_sizes.sorted.txt -b 0     | bedtools merge -i stdin     | gzip > ${tmpRegions}
