...
outMitoBam="W144.heart.apex.s1-merged.mito.bam"

sambamba merge --nthreads 8 ${outMitoBam} W144.heart.apex.s1-RUN001_L002.mito.bam W144.heart.apex.s1-RUN001_L001.mito.bam W144.heart.apex.s1-RUN001_L004.mito.bam W144.heart.apex.s1-RUN001_L003.mito.bam
