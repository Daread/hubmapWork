 ...
 plotViolins <- function(genesToPlot, setName, rnaData, outputDir = paste0("./plots/",  "expressionPlots/"),  #outputDir = paste0("./plots/", opt$predictionFraming, "/+                   cellTypeSubset=FALSE, cellTypeCol = "highLevelCellType",
 ...
 plotViolins(c("TGFB3", "CCN2"), "Fibr_TGFB_Hits", rnaData, cellTypeSubset=c("Fibroblast"), 
 ...
 plotPercentPosScatter <-function(genesToPlot, setName, rnaData, outputDir = paste0("./plots/",  "expressionPlots/"),  #outputDir = paste0("./plots/", opt$predictionFr+                   cellTypeSubset=FALSE, cellTypeCol = "highLevelCellType",
 ...
 plotPercentPosScatter(c("TGFB1", "TGFB2", "TGFB3 "), "TGFB_Aged_Fibroblasts", rnaData, cellTypeSubset="Fibroblast",
               colToGroupCells="Age", outputDir=outputDir)
