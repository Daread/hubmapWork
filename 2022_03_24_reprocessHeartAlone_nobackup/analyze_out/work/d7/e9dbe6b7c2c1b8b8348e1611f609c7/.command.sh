...
outCountReport="W145.heart.apex.s1-count_report.txt"

   Rscript /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/make_count_report.R W145.heart.apex.s1-duplicate_report.txt W145.heart.apex.s1-peak_counts.txt W145.heart.apex.s1-tss_counts.txt ${outCountReport}
