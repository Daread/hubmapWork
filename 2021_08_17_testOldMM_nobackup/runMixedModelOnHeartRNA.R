...
source("/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2021_08_17_testOldMM_nobackup/mixedModelFittingMonocle3Style.R")
...
mixedTestRes = fit_mixed_models(testCDS, modelFormula, c(fixedEffectVec, randomEffectVec),
                            expression_family="negbinomial", clean_model=T)
