...
outCounts="W146.heart.apex.s1-tss_counts.txt"
tmpRegions="W146.heart.apex.s1-temp_regions.gz"
   ...
   bedtools slop -i W146.heart.apex.s1-human.tss_file.sorted.bed.gz -g W146.heart.apex.s1-human.chromosome_sizes.sorted.txt -b 1000     | bedtools merge -i stdin     | gzip > ${tmpRegions}
