...
option_list = list(
    ...
    make_option(c("-m", "--matrixPath"), type="character", default="/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_03_24_reprocessHeartAlone_nobackup/analyze_out/", 
  ...
  make_option(c("-b", "--pvalToUse"), type="character", default=NULL, 
    ...
    make_option(c("-p", "--cdsPath"), type="character",# default="/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_04_03_redoATAC_proc_nobackup/archr/results/NB9/All_Cells/", # "peakMat" for greg/riza matrix, "bMat" for archr bins
    ...
    make_option(c("-a", "--ATACprocNote"), type="character", #default="FRIP=0.2_FRIT=0.05UMI=1000DL=0.5_useMNN_Peak_CDS_50k_20", 
                    default="PC_20_All_CellsFRIP=0.1_FRIT=0.08UMI=1000DL=0.5_ArchRActivharmonyLabels_regressProtocad_cds_p",
...
dir.create("/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_04_05_redoPeakMotifRegression_nobackup/rdsOutput/")
dir.create("/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_04_05_redoPeakMotifRegression_nobackup/rdsOutput/mixedModels/")

cellTypePath = "/net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_04_05_redoPeakMotifRegression_nobackup/rdsOutput/mixedModels/cellTypeSpec/"
