...
option_list = list(
  ...
  make_option(c("-f", "--ciceroCDS"), type="character", 
        default="Cicero_Defaults_PC_20_All_CellsFRIP=0.1_FRIT=0.08UMI=1000DL=0.5_ArchRActivharmonyLabels_regressProtocad_cds_p.rds_ciceroCDS.RDS", 
              help="Path to cds to process", metavar="character"),  

  make_option(c("-i", "--ciceroInputCDS"), type="character", 
        # default="Cicero_Defaults_cds_p_W144.heart.apex.s1_ciceroInput_CDS.RDS", 
        default="Cicero_Defaults_PC_20_All_CellsFRIP=0.1_FRIT=0.08UMI=1000DL=0.5_ArchRActivharmonyLabels_regressProtocad_cds_p.rds_ciceroInput_CDS.RDS", 
