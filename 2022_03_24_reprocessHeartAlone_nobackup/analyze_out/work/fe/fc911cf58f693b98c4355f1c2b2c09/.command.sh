...
outCountReport="W146.heart.LV.s1-count_report.txt"

   Rscript /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/make_count_report.R W146.heart.LV.s1-duplicate_report.txt W146.heart.LV.s1-peak_counts.txt W146.heart.LV.s1-tss_counts.txt ${outCountReport}
