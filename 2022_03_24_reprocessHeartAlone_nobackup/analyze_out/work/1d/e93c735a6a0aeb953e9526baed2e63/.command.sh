...
PROCESS_BLOCK='runAlignProcess'
   ...
   bowtieStderr="W142.heart.LV.s1-RUN001_L004.bowtie.stderr"
   samtoolsViewStderr="W142.heart.LV.s1-RUN001_L004.samtools_view.stderr"
   samtoolsSortStderr="W142.heart.LV.s1-RUN001_L004.samtools_sort.stderr"
outBam="W142.heart.LV.s1-RUN001_L004.bam"
   outMito="W142.heart.LV.s1-RUN001_L004.mito"

   if [ "true" == "true" ]
   then
     bowtie2 -3 1           -X 2000           -p 6           -x /net/bbi/vol1/data/genomes_stage/human/human_atac/human           -1 /net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_03_24_reprocessHeartAlone_nobackup/demux_out/W142.heart.LV.s1/fastqs_trim/W142.heart.LV.s1-RUN001_L004_R1.trimmed.fastq.gz           -2 /net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_03_24_reprocessHeartAlone_nobackup/demux_out/W142.heart.LV.s1/fastqs_trim/W142.heart.LV.s1-RUN001_L004_R2.trimmed.fastq.gz --seed 123456789 2> ${bowtieStderr}           | samtools view -h -L /net/bbi/vol1/data/genomes_stage/human/human_atac/whitelist_with_mt_regions.bed -f3 -F12 -q10 - 2> ${samtoolsViewStderr}           | /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/divert_mito_alignments.py -o ${outMito}.sam           | samtools sort -T ${outBam}.sorttemp --threads 4 -o ${outBam} - 2> ${samtoolsSortStderr}
