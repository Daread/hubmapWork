...
outGroupBed="group_1-group_merged_peaks_set.bed"
   ...
   do
     ...
     echo "W146.heart.LV.s1-peaks.narrowPeak.gz W145.heart.apex.s1-peaks.narrowPeak.gz W139.heart.LV.s1-peaks.narrowPeak.gz W139.heart.RV.s1-peaks.narrowPeak.gz W137.heart.apex.s1-peaks.narrowPeak.gz W136.heart.apex.s1-peaks.narrowPeak.gz W136.heart.LV.s1-peaks.narrowPeak.gz W145.heart.LV.s1-peaks.narrowPeak.gz W144.heart.apex.s1-peaks.narrowPeak.gz W135.heart.LV.s1-peaks.narrowPeak.gz W142.heart.LV.s1-peaks.narrowPeak.gz W139.heart.apex.s1-peaks.narrowPeak.gz W139.heart.septum.s1-peaks.narrowPeak.gz W146.heart.apex.s1-peaks.narrowPeak.gz W134.heart.apex.s1-peaks.narrowPeak.gz" > ${outBedList}
   done
