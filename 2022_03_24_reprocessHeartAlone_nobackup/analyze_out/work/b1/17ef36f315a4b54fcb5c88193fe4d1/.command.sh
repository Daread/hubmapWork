...
PROCESS_BLOCK='combineReadCountsProcess'
    ...
    outDuplicateReport="W134.heart.apex.s1-combined.duplicate_report.txt"

	python /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/combine_read_counts.py --input_duplicate_report W134.heart.apex.s1-duplicate_report.txt --input_mito_duplicate_report W134.heart.apex.s1-mito.duplicate_report.txt --output_combined_duplicate_report ${outDuplicateReport}
echo foo
