...
outBed="W139.heart.septum.s1-merged_peaks.bed"
cat inBeds*         | cut -f1-3         | sort -k1,1V -k2,2n -k3,3n         | bedtools merge -i -         | sort -k1,1V -k2,2n -k3,3n > ${outBed}

outBedList="W139.heart.septum.s1-merge_by_file_beds.txt"
echo "W139.heart.septum.s1-group_merged_peaks.bed" > ${outBedList}
