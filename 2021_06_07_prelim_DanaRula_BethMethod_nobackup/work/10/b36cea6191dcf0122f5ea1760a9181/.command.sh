...
cat start.log > trim.log
    printf "** Start process 'trim_fastqs' for Spleen.fq.part1-L003.fastq.gz at: $(date)
...
" >> piece.log
    ...
    printf "    Process command:
        trim_galore Spleen.fq.part1-L003.fastq.gz -a AAAAAAAA --three_prime_clip_R1 1
            --gzip -o ./trim_out/
...
" >> piece.log
    ...
    mkdir trim_out
    trim_galore Spleen.fq.part1-L003.fastq.gz         -a AAAAAAAA         --three_prime_clip_R1 1         --gzip         -o ./trim_out/
...
" >> piece.log
    cp piece.log Spleen.fq.part1-L003_trim.txt
