...
outMitoFragments="W145.heart.apex.s1-mito.fragments.txt"
outMitoTranspositionSites="W145.heart.apex.s1-mito.transposition_sites.bed"
outMitoInsertSizes="W145.heart.apex.s1-mito.insert_sizes.txt"
outMitoDuplicateReport="W145.heart.apex.s1-mito.duplicate_report.txt"

python /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/get_unique_fragments.py 		W145.heart.apex.s1-merged.mito.bam 		--fragments ${outMitoFragments} 		--transposition_sites_bed ${outMitoTranspositionSites} 		--duplicate_read_counts ${outMitoDuplicateReport} 		--insert_sizes ${outMitoInsertSizes}
