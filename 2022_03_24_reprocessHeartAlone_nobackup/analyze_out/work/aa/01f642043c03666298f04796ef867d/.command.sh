...
PROCESS_BLOCK='makeReducedDimensionMatrixProcess'
   ...
   inPeakMatrix="W145.heart.apex.s1-peak_matrix.mtx.gz"
   inSampleName="W145.heart.apex.s1"

	outScrubletHistFile="W145.heart.apex.s1-scrublet_hist.png"
   outScrubletTableFile="W145.heart.apex.s1-scrublet_table.csv"
outLsiCoordsFile="W145.heart.apex.s1-lsi_coords.txt"
outUmapCoordsFile="W145.heart.apex.s1-umap_coords.txt"
outUmapPlotFile="W145.heart.apex.s1-umap_plot"
outMonocle3CdsFile="W145.heart.apex.s1-monocle3_cds.rds"
   outBlackListRegionsFile="W145.heart.apex.s1-blacklist_regions_file.log"
   outReduceDimensionsLogFile="W145.heart.apex.s1-reduce_dimensions.log"
   umi_cutoff=100
   frip_cutoff=0.1
   frit_cutoff=0.05
