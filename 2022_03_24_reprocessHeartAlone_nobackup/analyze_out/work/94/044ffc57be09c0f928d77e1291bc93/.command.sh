...
outTxt="W139.heart.septum.s1-human.chromosome_sizes.sorted.txt"

cat /net/bbi/vol1/data/genomes_stage/human/human_atac/chromosome_sizes_atac.txt | sort -k1,1V -k2,2n -k3,3n > ${outTxt}
