...
outPromoterMatrix="W139.heart.LV.s1-promoter_matrix.mtx.gz"

   python /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/generate_sparse_matrix.py     --transposition_sites_intersect <(bedtools intersect -sorted -g W139.heart.LV.s1-human.chromosome_sizes.sorted.txt -a W139.heart.LV.s1-gene_regions.bed.gz -b W139.heart.LV.s1-transposition_sites.bed.gz -wa -wb)     --intervals W139.heart.LV.s1-gene_regions.bed.gz     --cell_whitelist W139.heart.LV.s1-called_cells_whitelist.txt     --matrix_output ${outPromoterMatrix}

   mv W139.heart.LV.s1-promoter_matrix.rows.txt promoter_matrix_rows.txt.no_metadata
