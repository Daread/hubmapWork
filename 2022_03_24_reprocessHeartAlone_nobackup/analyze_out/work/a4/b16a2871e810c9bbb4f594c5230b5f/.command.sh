...
outGcBinned="W146.heart.LV.s1-gc_${gc_bin_padded}-peak_calls.bb"

python /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/call_peak_motifs.py /net/bbi/vol1/data/genomes_stage/human/human_atac/Homo_sapiens.GRCh38.dna.toplevel.fa.finished W146.heart.LV.s1-merged_peaks.bed /net/trapnell/vol1/ajh24/common_data/sciatac_pipeline_data/common_files/motifs/JASPAR2018_CORE_vertebrates_non-redundant_pfms_jaspar.pfm ${outGcBinned} --gc_bin 16 --pwm_threshold 1E-7
