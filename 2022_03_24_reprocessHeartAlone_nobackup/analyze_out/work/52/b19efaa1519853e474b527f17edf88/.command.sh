...
PROCESS_BLOCK='runAlignProcess'
   ...
   bowtieStderr="W139.heart.LV.s1-RUN001_L002.bowtie.stderr"
   samtoolsViewStderr="W139.heart.LV.s1-RUN001_L002.samtools_view.stderr"
   samtoolsSortStderr="W139.heart.LV.s1-RUN001_L002.samtools_sort.stderr"
outBam="W139.heart.LV.s1-RUN001_L002.bam"
   outMito="W139.heart.LV.s1-RUN001_L002.mito"

   if [ "false" == "true" ]
   then
     bowtie2 -3 1           -X 2000           -p 6           -x /net/bbi/vol1/data/genomes_stage/human/human_atac/human           -1 /net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_03_24_reprocessHeartAlone_nobackup/demux_out/W139.heart.LV.s1/fastqs_trim/W139.heart.LV.s1-RUN001_L002_R1.trimmed.fastq.gz           -2 /net/trapnell/vol1/home/readdf/trapLabDir/hubmap/results/2022_03_24_reprocessHeartAlone_nobackup/demux_out/W139.heart.LV.s1/fastqs_trim/W139.heart.LV.s1-RUN001_L002_R2.trimmed.fastq.gz --seed 123456789 2> ${bowtieStderr}           | samtools view -h -L null -f3 -F12 -q10 - 2> ${samtoolsViewStderr}           | /net/trapnell/vol1/home/readdf/bin/bbi-sciatac-analyze/src/divert_mito_alignments.py -o ${outMito}.sam           | samtools sort -T ${outBam}.sorttemp --threads 4 -o ${outBam} - 2> ${samtoolsSortStderr}
