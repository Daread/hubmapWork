...
cat trim.log > align.log
    printf "** Start process 'align_reads' for Liver.fq.part2-L002_trimmed.fq.gz at: $(date)
...
" >> piece.log
    ...
    printf "    Process command:
        STAR --runThreadN 8 --genomeDir /net/bbi/vol1/data/genomes_stage/human/human_star
            --readFilesIn Liver.fq.part2-L002_trimmed.fq.gz --readFilesCommand zcat 
            --outFileNamePrefix ./align_out/Liver.fq.part2-L002 --outSAMtype BAM Unsorted 
...
" >> piece.log
    ...
    mkdir align_out
    STAR         --runThreadN 8         --genomeDir /net/bbi/vol1/data/genomes_stage/human/human_star         --readFilesIn Liver.fq.part2-L002_trimmed.fq.gz         --readFilesCommand zcat         --outFileNamePrefix ./align_out/Liver.fq.part2-L002          --outSAMtype BAM Unsorted         --outSAMmultNmax 1         --outSAMstrandField intronMotif
...
" >> piece.log
    ...
    cp piece.log Liver.fq.part2-L002_align.txt
