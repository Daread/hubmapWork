...
outCounts="W135.heart.LV.s1-peak_counts.txt"
tmpRegions="W135.heart.LV.s1-temp_regions.gz"
   ...
   bedtools slop -i W135.heart.LV.s1-merged_peaks.bed -g W135.heart.LV.s1-human.chromosome_sizes.sorted.txt -b 0     | bedtools merge -i stdin     | gzip > ${tmpRegions}
