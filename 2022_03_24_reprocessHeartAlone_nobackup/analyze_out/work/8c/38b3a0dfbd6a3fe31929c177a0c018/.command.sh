...
outBed="W134.heart.apex.s1-merged_peaks.bed"
cat inBeds*         | cut -f1-3         | sort -k1,1V -k2,2n -k3,3n         | bedtools merge -i -         | sort -k1,1V -k2,2n -k3,3n > ${outBed}

outBedList="W134.heart.apex.s1-merge_by_file_beds.txt"
echo "W134.heart.apex.s1-group_merged_peaks.bed" > ${outBedList}
