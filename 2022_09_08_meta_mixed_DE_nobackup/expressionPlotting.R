...
plotViolins(c("KCNJ3", "UTY", "LRFN5"), "Test_In_Cardio", rnaData, cellTypeCol = "Cell_Shared_Label",
				  cellTypeSubset=c("Ventricular_Cardiomyocytes"), 
            colToGroupCells="Sex", outputDir = outputDir)



plotViolins(c("KCNJ3", "GADD5G", "KDM6A", "DOK5"), "Cardio_Examples", rnaData, cellTypeCol = "Cell_Shared_Label",
          cellTypeSubset=c("Ventricular_Cardiomyocytes"), 
            colToGroupCells="Sex", outputDir = outputDir)

plotViolins(c("LINGO1", "KDM2B", "FUS", "SLC22A15", "RBM25", "KCNIP4"), "Neuron_Examples", rnaData, cellTypeCol = "Cell_Shared_Label",
          cellTypeSubset=c("Neurons"), 
